  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/rohit.nittala/"
            ...
            {/*<li>
              <a
                href="https://www.instagram.com/rohit_nittala/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/rohit-nittala/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Rohit</p>
        <p className="footer--content">Website still in progress, will add more features shortly...</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
